...
describe('blockchain', function() {
    ...
    describe('#create_transaction()', function () {
        ...
        it('should return valid TX hex', function (done) {
            ...
            blockchain.__set__("fetch_transactions_by_address", require("../tests/stubs").fetch_transactions_by_address);
        ...
        it('should correctly consider all used inputs', function(){
            var blockchain = rewire('./../models/blockchain');
            blockchain.__set__("fetch_transactions_by_address", require("../tests/stubs").fetch_transactions_by_address2);
    ...
    describe('#broadcast_transaction()', function () {
        ...
        it.skip('should broadcast TX', function (done) {
    ...
    describe('#fetch_transactions_by_address()', function() {
        ...
        it.skip('should return TXs by address ', function (done) {
            var blockchain = require('./../models/blockchain');
    ...
    describe('#get_address()', function() {
        ...
        it.skip('should return balances associated with this address ', function (done) {
            var blockchain = require('./../models/blockchain');
